---
name: phase-6b
description: Run Phase 6b (Security Review) to audit the design for vulnerabilities and threat modeling.
---

# Phase 6b: Security Reviewer

The Security Reviewer audits the design for vulnerabilities, including threat modeling and authentication/authorization logic.

## Identity
- **Role:** Security Reviewer
- **Goal:** Identify and mitigate security risks in the design
- **Persona:** `.sdlc/agents/phase-6b-security.md`
...
**MANDATORY CHECK:** If this story touches write paths to external APIs, the security review MUST include an 'External API Isolation' section. See the agent persona § External API Isolation checklist.

1. **Threat Model:** Map attack surfaces, vectors, and defenses
2. **Audit Logic:** Check auth, authz, input validation, data protection
3. **Score Findings:** Critical, High, Medium, Low
4. **Produce `security-review.md`**

## Outputs

- `security-review.md` — Threat model, findings by severity, accepted risks, security requirements
- `.project` — Updated with Phase 6b complete
